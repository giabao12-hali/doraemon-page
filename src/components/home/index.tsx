        ...
        <div className="bg-white h-screen">
            <div className="navbar sticky">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-xl text-cyan-500">
                        <div className="flex items-center gap-4">
                            {/* <img 
                                src="https://scontent.fsgn5-10.fna.fbcdn.net/v/t39.30808-6/245540820_897580130962933_729651761793930025_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=efb6e6&_nc_ohc=n1jlmLd2s7EAX-Jhiwx&_nc_ht=scontent.fsgn5-10.fna&oh=00_AfB4meyZ6rjBEmhfLHRmgZSiXv0Bhv6HK6v3-xGh32J_YQ&oe=65E20F7A" 
                                alt="Logo" 
                                className="w-12 h-auto rounded-md object-center bg-center" /> */}
                            <p>Love Mon</p>
                        </div>
                    </a>
                </div>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1">
                        <li><button className="btn no-animation btn-ghost text-black text-base font-semibold hover:text-cyan-500">Trang chủ</button></li>
                        <li><button className="btn no-animation btn-ghost text-black text-base font-semibold hover:text-cyan-500">Sản phẩm</button></li>
                        <li><button className="btn no-animation btn-ghost text-black text-base font-semibold hover:text-cyan-500">Về chúng tôi</button></li>
                        <li><button className="btn no-animation btn-ghost text-black text-base font-semibold hover:text-cyan-500">Liên hệ</button></li>
                    </ul>
                </div>
            ...
            <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://down-tx-vn.img.susercontent.com/5aa7483fcb8f1e7e7fc9841d031cab55.webp)' }}>
                <div className="hero-overlay bg-opacity-75"></div>
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-xl">
                        <h1 className="mb-5 text-5xl font-bold text-white">Chào mừng bạn đến với thế giới quà tặng <span className="text-cyan-400">Doraemon</span></h1>
                        <p className="mb-5 text-white">Cửa hàng này là điểm đến lý tưởng cho những người yêu thích <span className="text-cyan-400 font-bold">Doraemon</span>, với một bộ sưu tập đồ lưu niệm đa dạng từ những <span className="text-cyan-400 font-semibold"> chiếc móc khóa</span> đến những <span className="text-cyan-400 font-semibold">gấu bông</span>  đáng yêu, tất cả đều thấm đẫm bầu không khí ngọt ngào của thế giới của chú mèo máy thông minh này.</p>
                        <button className="btn btn-info">Bắt đầu nào</button>
                    </div>
                </div>
            </div>
            <section>
                <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                    <header className="text-center">
                        <h2 className="text-xl uppercase font-bold text-gray-900 sm:text-3xl">Sản phẩm nổi bật</h2>
                    </header>
                    <ul className="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <li>
                            <a href="#" className="group relative block">
                                <img
                                    src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lnwiu8yqyy2588"
                                    alt=""
                                    className="aspect-square w-full object-cover transition duration-500 group-hover:opacity-90"
                                />

                                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
                                    <h3 className="text-xl font-medium text-white">Gấu bông</h3>
                                    <span
                        ...
                        <li>
                            <a href="#" className="group relative block">
                                <img
                                    src="https://down-vn.img.susercontent.com/file/332b9150d223bbe8f430a4555a03cb02"
                                    alt=""
                                    className="aspect-square w-full object-cover transition duration-500 group-hover:opacity-90"
                                />

                                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
                                    <h3 className="text-xl font-medium text-white">Móc khóa</h3>
                        ...
                        <li className="lg:col-span-2 lg:col-start-2 lg:row-span-2 lg:row-start-1">
                            <a href="#" className="group relative block">
                                <img
                                    src="https://down-vn.img.susercontent.com/file/05856f63498c81f2b11be97a1213de66"
                                    alt=""
                                    className="aspect-square w-full object-cover transition duration-500 group-hover:opacity-90"
                                />

                                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
                                    <h3 className="text-xl font-medium text-white">Và còn nhiều thứ khác đang chờ bạn</h3>
            ...
            <section>
                <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                    <header className="text-center">
                        <h2 className="text-xl uppercase font-bold text-gray-900 sm:text-3xl">Toàn bộ sản phẩm</h2>
                    </header>
                            ...
                            <li key={index}>
                                <a href="#" className="group block overflow-hidden">
                                    <img
                                        src={data.img}
                                        alt={data.name}
                                        className="h-auto w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]"
                                    />

                                    <div className="relative bg-white pt-3">
                                        <h3 className="text-xs uppercase text-gray-700 group-hover:underline group-hover:underline-offset-1 transition-all duration-300 ease-in-out">
                                            {data.name}
                                        </h3>
                    ...
                    <div className="flex items-center justify-center">
                        <button className="btn btn-outline btn-info">Xem thêm toàn bộ sản phẩm</button>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                    <h2 className="text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl uppercase">
                        Những rì-viu xác thực từ khách hàng đã mua
                    </h2>
            ...
            <footer className="bg-gray-100">
                <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                    ...
                    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
                        LOVE MON - Quà tặng Doraemon
                    </p>

                    <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
                        <li>
                            <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Về tụi mình </a>
                        </li>

                        <li>
                            <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Chính sách bảo hành </a>
                        </li>

                        <li>
                            <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Chính sách thanh toán </a>
                        </li>

                        <li>
                            <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Chính sách giao hàng </a>
                        </li>

                        <li>
                            <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Liên hệ </a>
                        </li>
                    </ul>
                    ...
                    <ul className="mt-12 flex justify-center gap-6 md:gap-8">
                        <li>
                            <a
                                href="https://www.facebook.com/lovemon156"
                                rel="noopener"
                                target="_blank"
                        ...
                        <li>
                            <a
                                href="https://www.instagram.com/lovemon156/"
                                rel="noopener"
                                target="_blank"
                                className="text-gray-700 transition hover:text-gray-700/75"
                            >
                        ...
                        <li>
                            <a
                                href="https://shopee.vn/my_my1212"
                                rel="noopener"
                                target="_blank"
                                className="text-gray-700 transition hover:text-gray-700/75"
                            >
                                <span className="sr-only">Shopee</span>
                                <img className="h-6 w-6" src="https://upload.wikimedia.org/wikipedia/commons/0/0e/Shopee_logo.svg" alt="Shopee logo"/>
                            </a>
                        </li>
                    </ul>
                </div>
